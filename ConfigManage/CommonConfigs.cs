...
{
    public class CommonConfigs : IDisposable
    {
        /// <summary>
        /// 全局锁对象
        /// </summary>
        ...
        private CommonConfigs()
        {
            ...
            foreach (var item in GetConfigList())
            {
        ...
        /// 单例
        /// </summary>
        public static CommonConfigs Instance
        {
            get
            {
                if (instance == null)
    ...
    public class SqlServerServiceProvider : IServiceProvider
    {
        ...
        public string ConnectStr = System.Configuration.ConfigurationManager.ConnectionStrings["ConnectStr"].ConnectionString;
